...
abstract class $AppRouter extends _i7.RootStackRouter {
  ...
  final Map<String, _i7.PageFactory> pagesMap = {
    ...
    MarkerRoute.name: (routeData) {
      return _i7.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i7.WrappedRoute(child: const _i2.MarkerScreen()),
      );
    },
    ...
    SpecifyActivityDetailsRoute.name: (routeData) {
      ...
      return _i7.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i6.SpecifyActivityDetailsScreen(
          key: args.key,
...
/// generated route for
/// [_i2.MarkerScreen]
class MarkerRoute extends _i7.PageRouteInfo<void> {
  const MarkerRoute({List<_i7.PageRouteInfo>? children})
      : super(
          MarkerRoute.name,
          initialChildren: children,
        );
...
/// generated route for
/// [_i6.SpecifyActivityDetailsScreen]
class SpecifyActivityDetailsRoute
    extends _i7.PageRouteInfo<SpecifyActivityDetailsRouteArgs> {
  SpecifyActivityDetailsRoute({
    _i8.Key? key,
    required _i9.CreateActivityEntity createActivityEntity,
  ...
  static const _i7.PageInfo<SpecifyActivityDetailsRouteArgs> page =
      _i7.PageInfo<SpecifyActivityDetailsRouteArgs>(name);
}
...
class SpecifyActivityDetailsRouteArgs {
  ...
  final _i9.CreateActivityEntity createActivityEntity;
